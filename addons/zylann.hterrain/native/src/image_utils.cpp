...
void ImageUtils::_bind_methods() {
	ClassDB::bind_method(D_METHOD("get_red_range", "image_ref", "rect"), &ImageUtils::get_red_range);
	ClassDB::bind_method(D_METHOD("get_red_sum", "image_ref", "rect"), &ImageUtils::get_red_sum);
	ClassDB::bind_method(D_METHOD("get_red_sum_weighted", "image_ref", "brush_ref", "p_pos", "factor"), &ImageUtils::get_red_sum_weighted);
	...
	ClassDB::bind_method(D_METHOD("lerp_color_brush", "image_ref", "brush_ref", "p_pos", "factor", "target_value", "channel"), &ImageUtils::lerp_color_brush);
	ClassDB::bind_method(D_METHOD("generate_gaussian_brush", "image_ref"), &ImageUtils::generate_gaussian_brush);
	ClassDB::bind_method(D_METHOD("blur_red_brush", "image_ref", "brush_ref", "p_pos", "factor"), &ImageUtils::blur_red_brush);
	ClassDB::bind_method(D_METHOD("paint_indexed_splat", "index_map_ref", "weight_map_ref", "brush_ref", "p_pos", "texture_index", "factor"), &ImageUtils::paint_indexed_splat);
}
